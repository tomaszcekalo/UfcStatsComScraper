...
using System.Web;
using System.Xml;
using UfcStatsComScraper;

namespace UfcStatsScraper.ScrapySharp
{
    public class UfcStatsScraperScrapySharp : IUfcStatsScraper
    {
        private readonly ScrapingBrowser _browser;

        public UfcStatsScraperScrapySharp()
        {
            _browser = new ScrapingBrowser();
        }

        public UfcStatsScraperScrapySharp(ScrapingBrowser browser)
        {
            _browser = browser;
        }
        ...
        public async Task<IEnumerable<EventListItem>> ScrapeUpcoming(int? page = null)
        {
            ...
            WebPage homePage = await _browser.NavigateToPageAsync(uri);
        ...
        {
            WebPage homePage = await _browser.NavigateToPageAsync(new Uri(url));
